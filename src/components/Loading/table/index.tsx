...
const Table: FC<TableProps> = ({ columns = [], data: propsData = [] }) => {
  ...
  const { trigger: editdata } = useRequestMutation("listdata", {
    method: "PUT",
    module: "listApi",
  });
  ...
  const tableData = data || propsData;
  ...
  return (
    <div className="flex flex-col">
      <div className="shadow p-3 mb-5 rounded-lg bg-white flex items-center justify-between">
        <div className="flex gap-3 items-center">
          <button className=" bg-[#019FA2] text-white text-[14px] px-3 py-1.5 rounded-[4px] font-semibold">
            + New Project
          </button>
          <select className="border w-[148px] px-3.5 py-1.5 text-gray-400 rounded-[4px] text-sm">
            <option className="bg-[#019FA2] text-white cursor-pointer">
              Sort by
            </option>
            <option className="bg-white text-[#019FA2]">A - Z</option>
            <option className="bg-white text-[#019FA2]">Date Added</option>
            <option className="bg-white text-[#019FA2]">Newest</option>
            <option className="bg-white text-[#019FA2]">Type</option>
          </select>
        </div>
        ...
        <div className="flex items-center">
          <Image
            ...
            width={24}
            height={24}
            className="rounded-full me-[-0.20rem] hover:z-[1] hover:scale-110 hover:border-white transition hover:border-2 border-white"
          />
          <Image
            src="https://spruko.com/demo/xintra/dist/assets/images/faces/12.jpg"
            alt="Descriptive Alt Text"
            width={24}
            height={24}
            className="rounded-full me-[-0.20rem] hover:z-[1] hover:scale-110 hover:border-white transition hover:border-2 border-white"
          ...
          />
          <Image
            src="https://spruko.com/demo/xintra/dist/assets/images/faces/10.jpg"
            alt="Descriptive Alt Text"
            width={25}
            height={25}
            className="rounded-full me-[-0.20rem] hover:z-[1] hover:scale-110 hover:border-white transition hover:border-2 border-white"
          ...
          <div className="rounded-full w-[25px] h-[25px] text-white bg-[#019FA2] text-[11px] font-bold flex items-center justify-center cursor-pointer hover:border-2 border-white me-[-0.20rem] hover:z-[1] hover:scale-110 transition bg-main_color">
            +8
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          />
          <button className="text-sm rounded bg-gray-100 font-semibold py-2 px-2">
            Search
          </button>
        </div>
      </div>
            ...
            <table className="table-auto min-w-full rounded-xl">
              <thead>
                <tr className="bg-gray-50">
                  <th className="px-4 py-2 border-b-2 text-left text-[14px] font-normal">
                    Project Name
                  </th>
                  <th className="px-4 py-2 border-b-2 text-left text-[14px] font-normal">
                    Description
                  ...
                  >
                    ...
                    <td className="px-1 py-3">
                      <div className="flex items-center gap-3">
                        <Image
                          src={
                            row.nameimage || "https://via.placeholder.com/35"
                          }
                          width={35}
                          height={35}
                          alt="Company Logo"
                        ...
                        <div className="data">
                          ...
                          <p className="font-normal text-xs leading-5 text-gray-400">
                            Total <span>18/22</span> tasks completed
                          </p>
                        </div>
                      </div>
                    </td>
                    <td className="w-[350px] text-[13px] p-[13px] font-medium text-[#6E829F]">
                      <p>
                    ...
                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                      <div className="flex items-center">
                        ...
                        />
                        <Image
                          src={row.teamimg2 || "https://via.placeholder.com/25"}
                          alt="Team Member"
                          width={25}
                          height={25}
                          className="rounded-full me-[-0.20rem] hover:z-[1] hover:scale-110 hover:border-white transition"
                        />
                        <Image
                          src={row.teamimg3 || "https://via.placeholder.com/25"}
                          alt="Team Member"
                          width={25}
                          height={25}
                          className="rounded-full me-[-0.20rem] hover:z-[1] hover:scale-110 hover:border-white transition"
                        />
                        <Image
                          src={row.teamimg4 || "https://via.placeholder.com/25"}
                          alt="Team Member"
                          width={25}
                          height={25}
                          className="rounded-full me-[-0.20rem] hover:z-[1] hover:scale-110 hover:border-white transition"
                    ...
                    <td className="p-5 whitespace-nowrap text-[13px] leading-6 font-medium text-gray-900">
                      {row.assigneddate || "No Date"}
                    </td>
                    <td className="p-5 whitespace-nowrap text-[13px] leading-6 font-medium text-gray-900">
                      {row.duedata || "No Due Date"}
                    </td>
                    <td className="px-4 py-3 border-b text-[13px]">
                      <div className="w-full bg-gray-200 rounded-full h-1">
                        <div
                          className="bg-[#019FA2] h-1 rounded-full"
                          style={{ width: `${row.status || 0}%` }}
                        ></div>
                      </div>
                    ...
                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                      <div className="py-1.5 px-2.5 bg-yellow-100 rounded-full flex w-20 justify-center items-center gap-1">
                        <svg
                          width="4"
                          height="4"
                          viewBox="0 0 5 6"
                        ...
                        <span className="font-bold text-[12px] text-yellow-400">
